...
class ServiceTicketTableTest extends PHPUnit_Framework_TestCase
{
    public function testFetchAllReturnsAllAlbums()
    {
        ...
        $serviceTicket = new ServiceTicketTable($mockTableGateway);

        $this->assertSame($resultSet, $serviceTicket->fetchAll());
    }
